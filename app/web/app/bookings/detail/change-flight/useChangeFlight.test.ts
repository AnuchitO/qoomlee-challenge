...
import { mockFlightAlternatives } from "@/lib/flight/mock";

const mockPush = vi.fn();
vi.mock("next/navigation", () => ({
  useSearchParams: () => new URLSearchParams({ ref: "QM1234" }),
...
describe("useChangeFlight", () => {
  ...
  it("handleSelect marks the flight as confirming, then navigates to the booking", () => {
    ...
    expect(mockPush).toHaveBeenCalledWith("/bookings/detail?ref=QM1234");
  });
});
