...
import type { UploadCard } from "./useHealthDocuments";

interface HealthDocumentsViewProps {
  ref: string;
  docs: UploadCard[];
...
export function HealthDocumentsView({
  ref,
  docs,
  uploads,
  handleUpload,
  handleRemove,
}: HealthDocumentsViewProps) {
  return (
