import { CHECKIN_TABS, type CheckInTab } from "./useCheckInDetails";

interface CheckInDetailsViewProps {
  activeTab: CheckInTab;
  setActiveTab: (tab: CheckInTab) => void;
  bags: number;
  incrementBags: () => void;
  decrementBags: () => void;
  carryOnConfirmed: boolean;
  handleCarryOnChange: (e: React.ChangeEvent<HTMLInputElement>) => void;
  goToSeats: () => void;
  completeCheckIn: () => void;
}

export function CheckInDetailsView({
  activeTab,
  setActiveTab,
  bags,
  incrementBags,
