...
const navItems = [
  { href: "/flights", icon: "search", label: "Search" },
...
export default function BottomNav() {
  ...
  return (
    <nav className="md:hidden bg-surface-container-lowest border-t border-outline-variant shadow-[0px_-2px_10px_rgba(0,0,0,0.05)] fixed bottom-0 left-0 w-full flex justify-around items-center h-20 px-sm z-50">
