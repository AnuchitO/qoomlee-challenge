...
// seedDate returns the calendar date `days` days from now in UTC, for use with
// bkkDateToUTCRange. It matches the CURRENT_DATE + INTERVAL 'days' departure
// dates generated by 02_seed.sql (the postgres:16-alpine container's timezone
// defaults to UTC, same as CURRENT_DATE there).
